    ...
    <div class="container">
        ...
        <div class="slidebar-stickiy-container">
            ...
            <div class="content">
                ...
                <!-- INTRO SECTION -->
                <div id="intro">
                    <h2>From Messy to Mastered: A Sequential Guide to Data Cleaning</h2>
                ...
                <section>
                    ...
                    <p>According to multiple studies, <strong>data scientists spend 60–80% of their time</strong> cleaning and preparing data. This reality highlights the importance of doing the job correctly.</p>
                </section>
                ...
                <section>
                    ...
                    <p>Go to <strong>Home → Conditional Formatting → Highlight Cell Rules → Duplicate Values</strong>. This is a safer preview approach that doesn't delete data.</p>

                    <p><strong>Method 3: Filter Unique Values</strong></p>
                    <p>Use <strong>Data → Advanced Filter → Unique records only</strong> to hide duplicates while keeping your original data intact.</p>
                </section>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li><strong>Standardize dates:</strong> Navigate to <strong>Home → Number Format → Date</strong>.</li>
                    </ul>
