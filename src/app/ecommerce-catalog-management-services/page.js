...
import {ecommerceCatalogmanagementServicesSchema} from "@/libs/schema/services/ecommerceCatalogmanagementServicesSchema";
export const metadata = {
    ...
    alternates: {
        canonical: "https://www.computyne.com/ecommerce-catalog-management-services",
    },
};
export default function ecommerceCatalogmanagementServices() {

    return (
        <>
            <JsonLd
                id="ecommerce-catalog-management-services-schema"
                schema={ecommerceCatalogmanagementServicesSchema}
                ...
                <div id="smooth-wrapper">
                    <div id="smooth-content">
                        <main>
                            ...
                            <Banner/>
                            <Counter/>
                            <Aboutus slug={"ecommerce-catalog-management-services"} type={1}/>
                            <Subservices/>
