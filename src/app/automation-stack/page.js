...
const AutomationStackPage = () => {
    return (
        <>
            <Head>
                <title>The Automation Stack Computyne Builds On | Computyne</title>
                <meta name="description" content="AI agents and automated workflows built on orchestration platforms, model interfaces, protocol standards, and integration layers. Platform-agnostic and model-agnostic solutions." />
            </Head>

            <div className="automation-stack-page">
                <section className="hero-section section-gap-y">
                ...
                <section className="workflow-orchestration section-gap-y">
                    <div className="container">
                        <h2 className="section-title">Workflow Orchestration Platforms</h2>
                ...
                <section className="agentic-frameworks section-gap-y bg-light">
                    <div className="container">
                        <h2 className="section-title">Agentic AI Frameworks</h2>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
                ...
                <section className="mcp-integration section-gap-y">
                    <div className="container">
                        <h2 className="section-title">MCP Server Integration: Connecting AI Agents to Any Tool or Data Source</h2>
                        ...
                        <h3 className="subsection-title">What Computyne Connects via MCP</h3>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
                        ...
                        <h3 className="subsection-title">Why MCP Matters for Enterprise Clients</h3>
                ...
                <section className="llm-providers section-gap-y bg-light">
                    <div className="container">
                        <h2 className="section-title">LLM-Agnostic Development: The Right Model for Every Task</h2>
                        <p className="section-description">
                        ...
                        <h3 className="subsection-title">Model-Mixing Cost Strategy</h3>
                        <p className="section-description">
                ...
                <section className="productivity-integrations section-gap-y">
                    <div className="container">
                        <h2 className="section-title">AI Agents That Connect to Your Entire Tool Stack</h2>
                        <p className="section-description">
                        ...
                        <h3 className="subsection-title">Communication and Collaboration</h3>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
                        ...
                        <h3 className="subsection-title">CRM, Sales and Marketing</h3>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
                        ...
                        <h3 className="subsection-title">Project Management and Developer Tools</h3>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
                        ...
                        <h3 className="subsection-title">Finance, HR and Operations</h3>
                        <div className="table-responsive">
                            <table className="automation-table">
                                <thead>
                                    <tr>
...
export default AutomationStackPage;
