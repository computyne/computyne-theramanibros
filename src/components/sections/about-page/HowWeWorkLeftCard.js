...
const HowWeWorkLeftCard = ({ hwwMain, activeHww, handleClick }) => {
	const {
		id,
		name,
	} = hwwMain || {};
	const isActive = hwwMain.id === activeHww?.id;
	return (
		<div
			className={`how-we-work-item 
				${id === activeHww?.id ? "active" : ""
				}
			 wow fadeInUp`}
			data-wow-delay=".3s"
			// onMouseEnter={() => handleMouseEnter(teamMember)}
			onClick={() => handleClick(hwwMain)}
			role="button"
			tabIndex={0}
			onKeyDown={(e) => e.key === "Enter" && handleClick(hwwMain)}
		>
			<div className="how-we-work-item-inner">
			...
			{activeHww.id === 1 && (<div className="how-we-work-right-wrap" data-wow-delay=".1s">
				<div
			...
			{activeHww.id === 2 && (<div className="how-we-work-right-wrap" data-wow-delay=".1s">
				<div
					id="how-we-work-right"
					className="how-we-work-right team-pad-18"
					style={{
			...
			{activeHww.id === 3 && (<div className="how-we-work-right-wrap" data-wow-delay=".1s">
				<div
					id="how-we-work-right"
					className="how-we-work-right team-pad-18"
					style={{
...
export default HowWeWorkLeftCard;
