...
import getProcessData from "@/libs/service/getProcessData";

const Process = () => {
    const pathname = usePathname();
    const slug = pathname.split("/").filter(Boolean).pop();
    const processData = getProcessData(slug);
    ...
    const h2 = processData?.h2 || "Seamless Process, Great Results.";
    return (
            ...
            <div className="container">
                ...
                <div
                    ...
                    <div className="sec-heading style-2 style-6">
                        ...
                        <h2 className="sec-title title-anim" dangerouslySetInnerHTML={{__html: h2}}></h2>
